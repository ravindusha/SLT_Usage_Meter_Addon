...
function getData(){
    ...
    remainingValueElement.setAttribute("style",`font: 700 1.5rem 'Open Sans'; color:${offpeakRemainingPercentage<10 ?'rgb(254, 33, 33);': offpeakRemainingPercentage<30 ?'rgb(255, 191, 0)':'rgb(37, 151, 216)'};`);
    ...
    datasets: [{
        ...
        backgroundColor:[offpeakRemainingPercentage<10 ?'rgb(254, 33, 33)' :offpeakRemainingPercentage<30 ?'rgb(255, 191, 0)' :'rgb(37, 151, 216)',offpeakRemainingPercentage<10 ?'rgba(254, 33, 33, 0.2)' :offpeakRemainingPercentage<30 ? 'rgba(255, 191, 0, 0.2)':'rgba(20, 128, 225, 0.2)']
    }],
